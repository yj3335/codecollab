export function buildSystemPrompt(sourceLang: string, targetLang: string): string {
  ...
  return [
    ...
    ...hints,
    `- The "explanation" field must briefly describe any semantic gaps between ${sourceLang} and ${targetLang}, for example:`,
    ...
    `- If the code cannot be meaningfully translated, set translatedCode to an empty string and explain why in explanation`,
